...
const TopicsDisplay = () => {
  ...
  return (
    <div class="flex w-full flex-col items-center justify-center space-y-6 rounded-lg border border-violet-400 py-2 dark:border-slate-600 md:max-w-[75%]">
      <div class="flex w-full items-center justify-center space-x-3 border-b border-violet-400 py-2 dark:border-slate-700">
        <div class="w-fit text-2xl font-bold text-blue-700 dark:text-white">
          Your Topics
        </div>
        {!showCreateTopicForm() && (
          <button
            class="rounded-full border border-teal-300 bg-transparent p-2 text-green-500 dark:border-green-700"
            onClick={() => {

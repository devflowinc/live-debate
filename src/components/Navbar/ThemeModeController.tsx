        ...
        {({ isOpen }) => (
          <>
            ...
            >
              ...
              >
                <Menu class="flex flex-col space-y-1 overflow-hidden rounded-lg border border-slate-900 bg-neutral-50 p-1 shadow-lg drop-shadow-lg dark:bg-slate-700 dark:text-white">
                  <MenuItem as="button" aria-label="Empty" />
                  <MenuItem
                    as="div"
                    class="flex space-x-2 rounded-md py-1 px-2 focus:bg-gray-100 focus:outline-none hover:cursor-pointer dark:focus:bg-gray-600 dark:hover:bg-gray-600 dark:hover:bg-none"
                    onClick={() => {
                      setThemeMode("light");
                  ...
                  <MenuItem
                    as="div"
                    class="flex space-x-2 rounded-md py-1 px-2 focus:bg-gray-100 focus:outline-none hover:cursor-pointer hover:bg-gray-100 dark:focus:bg-gray-600 dark:hover:bg-gray-600"
                    onClick={() => {
                      setThemeMode("dark");
                      setCurrentTheme(getThemeMode());
                    }}
